...
namespace Behaviour
{
    public class EnemyBehaviour : MonoBehaviour
    {
        ...
        void PaintPath()
        {
            ...
            TileManager.Instance.ground.GetComponentsInChildren<GroundTileBehaviour>().ToList()
                .FindAll(g => g.transform.position != _actualPositionTile.transform.position).ForEach(t =>
                {
                    ...
                    float distance = PathFinding.PathFinding.Instance.GetManhattenDistance(_actualPositionTile.transform.position, t.transform.position);
            ...
            _pathFindPositions = PathFinding.PathFinding.Instance.FindPath(_actualPositionTile, targetGo);
        ...
        {
            Vector2 direction = PathFinding.PathFinding.Instance.GetDirectionOfMovement(nextPos.Position, transform.position);
